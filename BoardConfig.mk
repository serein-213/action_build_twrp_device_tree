...
# Copy prebuilt libcryptfs_hw.so (C interface, compatible with TWRP)
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/prebuilt/libcryptfs_hw.so:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/lib64/libcryptfs_hw.so
